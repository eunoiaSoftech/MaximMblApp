                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              getValidatedString(profileController
                                                      .response
                                                      .value
                                                      ?.data['data1'][0][
                                                  'sUserMobileNo']), // Replace with actual user name
                                              style: AppStyles.titleTextStyle(
                                                      context)
                                                  .copyWith(
                                                color: AppColors.textWhiteColor
                                                  ...
                                                  Text(
                                                    getValidatedString(
                                                        profileController
                                                                    ...
                                                                    ?.data[
                                                                'data1'][0][
                                                            'sDriverLicense']), // Replace with actual user name
                                                    style: AppStyles
                                                            .titleTextStyle(
                                                                context)
                                                        .copyWith(
                                                  ...
                                                  Text(
                                                    getValidatedString(
                                                        profileController
                                                                    ...
                                                                    ?.data[
                                                                'data1'][0][
                                                            'sDriverLicenseExpDate']), // Replace with actual user name
                                                    style: AppStyles
                                                            .titleTextStyle(
                                                                context)
                                                        .copyWith(
