...
import 'package:logistics_app/core/shared/widgets/app_snackbar.dart';
...
import 'package:logistics_app/features/branches_n_locations/presentation/ui/locationlist_bottomsheet_widget.dart';
              ...
              AppBottomSheet.show(
                  ...
                  then: (v) {
                    if (v != null &&
                        ...
                        v[2] != null) {
                      setState(() {
                        _selectedBranchId = v[1];
                        _branchTextController.text = v[2];
                      });

                      context.read<LocationListBloc>().generateLocationList(
                          _selectedBranchId ?? 0, widget.userId ?? 0);

                      log("_selectedBranchId > $_selectedBranchId");
                    }
                  });
            },
            child: AppTextField(
          ...
          GestureDetector(
            onTap: () {
              if (_selectedBranchId == null) {
                AppSnackBar.show(context, "Please select branch first");
                return;
              }
              ...
              AppBottomSheet.show(
                  ...
                  context: context,
                  child: LocationListBottomSheetWidget(
                      userId: widget.userId ?? 0,
                      branchId: _selectedBranchId ?? 0),
                  then: (v) {
                    if (v != null && v[0] == true && v[1] != null) {
                      setState(() {
                        _selectedLocationId = v[1];
                        _locationTextController.text = v[2];
                      });
                      _selectedBranchId = v[1];
                      log("_selectedLocationId > $_selectedBranchId");
                    }
                  });
            },
            child: AppTextField(
